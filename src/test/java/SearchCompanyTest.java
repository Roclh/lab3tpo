...
public class SearchCompanyTest {
    ...
    public void testSearchNew() {
        ...
        chromeDriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        String result = searchPage.getCompanySearchResultNumber().getText() + " "
                + searchPage.getCompanySearchResultCompany().getText() + " "
                + searchPage.getCompanySearchResultFound().getText();
