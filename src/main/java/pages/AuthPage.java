...
public class AuthPage {
    ...
    @FindBy(xpath = "/html/body/div/div/div[3]/div/div/div/div/div/div/div/div/div/form/div/fieldset/input")
    ...
    @FindBy(xpath = "/html/body/div/div/div[3]/div/div/div/div/div/div/div/div/div/div[2]/form/div[5]/button[2]")
    private WebElement loginWithPasswordButton;

    @FindBy(xpath = "/html/body/div/div/div[3]/div/div/div/div/div/div/div/div/div/form/div[2]/fieldset/input")
    private WebElement passwdField;

    @FindBy(xpath = "/html/body/div/div/div[3]/div/div/div/div/div/div/div/div/div/form/div[2]/fieldset/span/button")
    private WebElement passwdButton;

    @FindBy(xpath = "/html/body/div/div/div[3]/div/div/div/div/div/div/div/div/div/form/div[5]/div/button")
